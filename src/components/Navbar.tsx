    ...
    <nav className="sticky top-0 z-50 border-b border-border/60 bg-card/70 backdrop-blur-xl shadow-navbar">
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <div className="hidden md:flex items-center gap-0.5">
          ...
          <Link to="/how-it-works">
            <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors">How It Works</Button>
          </Link>
          <Link to="/about">
          ...
          <Link to="/faq">
            <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors">FAQ</Button>
          </Link>
          <Link to="/register">
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-border/60 bg-card px-4 py-5 space-y-2 animate-fade-in">
          ...
          <Link to="/how-it-works" onClick={() => setMenuOpen(false)} className="block py-2.5 px-3 text-sm font-medium rounded-lg hover:bg-secondary transition-colors">How It Works</Link>
          ...
          <Link to="/faq" onClick={() => setMenuOpen(false)} className="block py-2.5 px-3 text-sm font-medium rounded-lg hover:bg-secondary transition-colors">FAQ</Link>
