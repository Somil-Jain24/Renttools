  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "elevated-lg": "0 16px 48px rgba(0,0,0,0.08), 0 4px 12px rgba(0,0,0,0.04)",
        glow: "0 0 20px rgba(45,160,130,0.15)",
        navbar: "0 1px 3px rgba(0,0,0,0.04), 0 4px 20px rgba(0,0,0,0.03)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
